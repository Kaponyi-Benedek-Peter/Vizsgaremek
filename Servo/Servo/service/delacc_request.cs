...
namespace Servo.service
{
    internal class delacc_request
    {
        ...
        public static void sendaccdeletion(string email)
        {
            string confirmation_token = service.shared.gen_code(false);
            
            service.shared.send_mail(email, "Account deletion", accdeletionhtml_top + $"{service.shared.current_url}?accdel=" + service.shared.b64enc(email) + ";" + service.shared.b64enc(confirmation_token) + accdeletionhtml_bottom, "accdeletion");
