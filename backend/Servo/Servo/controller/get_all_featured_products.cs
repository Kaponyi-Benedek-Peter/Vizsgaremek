    ...
    internal class get_all_featured_products
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                service.shared.log("Get all featured products request: (" + data.Request.RemoteEndPoint.Address.ToString() + ")");
                ...
                string resp = service.get_all_featured_products.process_get_all_featured_products(); // SERVICE
                if (resp != "error")
                {
