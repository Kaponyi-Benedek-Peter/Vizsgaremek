        ...
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    id = service.shared.b64dec(jsonObj["product_id"].ToString());
                ...
                service.shared.log("Get all product images by id request: " + id + "  (" + data.Request.RemoteEndPoint.Address.ToString());
                ...
                string resp = service.get_all_product_images_by_id.process_get_all_product_images_by_id(id); // SERVICE
                if (resp != "error")
                {
            ...
            {
                service.shared.log($"Error 1: {ex.Message} --controller.get_all_product_images_by_id");
