    ...
    internal class delete_post_image_by_id_admin
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                service.shared.log("Delete post image request: " + admin_id + "  " + sesstoken + "  " + post_id + "  (" + data.Request.RemoteEndPoint.Address.ToString());
                ...
                int resp = service.delete_post_image_by_id_admin.process_delete_post_image_by_id_admin(admin_id, sesstoken, post_id, image_id); // SERVICE
                if (resp == 200)
                {
            ...
            {
                service.shared.log($"Error 1: {ex.Message} --controller.delete_post_image_by_id_admin.main");
