...
{
    internal class delete_post_comment_by_comment_id
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    comment_id = service.shared.b64dec(jsonObj["comment_id"].ToString());
                }
                catch
                {
                    var respon_2 = new
                ...
                int resp = service.delete_post_comments_by_comment_id.process_delete_post_comments_by_comment_id(
                    controller_user_id,
            ...
            {
                service.shared.log($"Error: {ex.Message} --controller.delete_post_comment_by_comment_id");
