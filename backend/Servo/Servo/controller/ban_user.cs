    ...
    internal class ban_user
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                service.shared.log("Ban user request: " + admin_id + "  " + sesstoken + "  " + target_user_id + "  (" + data.Request.RemoteEndPoint.Address.ToString());
                ...
                int resp = service.ban_user.process_ban_user(admin_id, sesstoken, target_user_id); // SERVICE
                if (resp == 200)
                {
