    ...
    internal class delete_product_by_id
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                service.shared.log("Delete post request: " + admin_id + "  " + sesstoken + "  " + product_id + "  (" + data.Request.RemoteEndPoint.Address.ToString());
                ...
                int resp = service.delete_product_by_id.process_delete_product_by_id(admin_id, sesstoken, product_id); // SERVICE
                if (resp == 200)
                {
                ...
                else if (resp == 409)
                {
                    ...
                    var respon = new
                    {
                        status = "already_deleted_or_indexistent_product",
                        statuscode = "409"
                    };
            ...
            {
                service.shared.log($"Error 1: {ex.Message} --controller.delete_product_by_id.main");
