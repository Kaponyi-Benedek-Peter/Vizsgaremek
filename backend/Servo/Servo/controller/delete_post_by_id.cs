    ...
    internal class delete_post_by_id
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                service.shared.log("Delete post request: " + admin_id + "  " + sesstoken + "  " + post_id + "  (" + data.Request.RemoteEndPoint.Address.ToString());
                ...
                int resp = service.delete_post_by_id.process_delete_post_by_id(admin_id, sesstoken, post_id); // SERVICE
                if (resp == 200)
                {
