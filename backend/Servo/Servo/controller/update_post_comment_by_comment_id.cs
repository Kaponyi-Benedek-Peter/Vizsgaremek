    ...
    internal class update_post_comment_by_comment_id
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                int resp = service.update_post_comment_by_comment_id.process_update_post_comment_by_comment_id(
                    controller_user_id,
            ...
            {
                service.shared.log($"Error: {ex.Message} --controller.update_post_comment_by_comment_id");
