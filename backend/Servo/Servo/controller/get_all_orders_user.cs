    ...
    internal class get_all_orders_user
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                {
                    service.shared.log($"Debug 1: hibas input --controller.get_all_orders_user");
                ...
                service.shared.log("Get all orders (user) request: (" + data.Request.RemoteEndPoint.Address.ToString() + ")");
                ...
                (int responsecode, string responsedata) resp = service.get_all_orders_user.process_get_all_orders_user(user_id, session_token); // SERVICE

                service.shared.log($"Debug 1: controller.get_all_orders_user.main -- response code: {resp.responsecode}");
            ...
            {
                service.shared.log($"Error 1: {ex.Message} --controller.get_all_orders_user.main");
