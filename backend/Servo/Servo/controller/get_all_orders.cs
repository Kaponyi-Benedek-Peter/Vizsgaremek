    ...
    internal class get_all_orders
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                {
                    service.shared.log($"Debug 1: hibas input --controller.get_all_orders");
                ...
                service.shared.log("Get all orders request: (" + data.Request.RemoteEndPoint.Address.ToString() + ")");
                ...
                (int responsecode, string responsedata) resp = service.get_all_orders.process_get_all_orders(user_id, session_token); // SERVICE

                service.shared.log($"Debug 1: controller.get_all_orders.main -- response code: {resp.responsecode}");
            ...
            {
                service.shared.log($"Error 1: {ex.Message} --controller.get_all_orders.main");
