    ...
    internal class get_product_by_id
    {
        public static void main(HttpListenerContext data, string lenyeg)
        {
            ...
            try
            {
                ...
                service.shared.log("Get product request: " + id + "  (" + data.Request.RemoteEndPoint.Address.ToString());
                ...
                string resp = service.get_product_by_id.process_get_product_by_id(id); // SERVICE
                if (resp != "error")
                {
