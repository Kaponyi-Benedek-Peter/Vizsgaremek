...
namespace Servo.service
{
    internal class newsletter_subscription
    {
        ...
        public static void sendwelcome(string hova)
        {


            service.shared.send_mail(hova, "Welcome to Roy's Shack!", loginhtml_top + $"{service.shared.current_url}?unsubscribe=" + service.shared.b64enc(hova) + loginhtml_bottom, "newsletter subscription");
