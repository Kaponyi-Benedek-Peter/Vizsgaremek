...
namespace Servo.service
{
    internal class delete_all_post_comments
    {
        ...
        public static int process_delete_all_post_comments(string controller_admin_id, string controller_sesstoken)
        {
            ...
            if (model_sesstoken == controller_sesstoken && (admin_accstate == "admin" || admin_accstate == "superadmin"))
            {
                ...
                //do
                int result = model.shared.delete_all_post_comments();
