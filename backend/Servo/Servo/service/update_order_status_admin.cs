...
namespace Servo.service
{
    internal class update_order_status_admin
    {
        ...
        public static int process_update_order_status_admin(string controller_admin_id, string controller_sesstoken, string controller_target_order_id, string new_order_status)
        {
            ...
            if (model_sesstoken == controller_sesstoken)
            {
                ...
                if ((admin_accstate == "admin" || admin_accstate == "superadmin"))
                {
                    ...
                    int result = model.shared.update_order_status_by_id(controller_target_order_id, new_order_status);
