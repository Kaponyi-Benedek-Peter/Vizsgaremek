...
namespace Servo.service
{
    ...
    {
        public static string process_get_all_product_images_by_id(string category)
        {
            ...
            try
            {
                resp = model.get_all_product_images_by_id.communicate_get_all_product_images_by_id(category);
            }
            catch (Exception ex) { service.shared.log($"Error 1: {ex.Message} --service.get_all_product_images_by_id.process_get_all_product_images_by_id"); }
            ...
            */
            ...
            {
                shared.log($"Debug 1: {resp["status"]} --service.get_all_product_images_by_id.process_get_all_product_images_by_id");
                return "error";
            }
            else
            {
