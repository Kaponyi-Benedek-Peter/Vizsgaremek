...
namespace Servo.service
{
    ...
    {
        public static string process_get_all_post_categories()
        {
            ...
            try//
            {
                resp = model.get_all_post_categories.communicate_get_all_post_categories();
            }
            catch (Exception ex) { service.shared.log($"Error 1: {ex.Message} --service.get_all_post_categories.process_get_all_post_categories"); }
            ...
            */
            ...
            {
                shared.log($"Debug 1: {resp["status"]} --service.get_all_post_categories.process_get_all_post_categories");
                return "error";
            }
            else
            {
