...
namespace Servo.service
{
    internal class delete_product_by_id
    {
        ...
        public static int process_delete_product_by_id(string controller_admin_id, string controller_sesstoken, string product_id)
        {
            ...
            if (model_sesstoken == controller_sesstoken && (admin_accstate == "admin" || admin_accstate == "superadmin"))
            {
                ...
                //do
                int result = model.delete_product_by_id.communicate_delete_product_by_id(product_id);
