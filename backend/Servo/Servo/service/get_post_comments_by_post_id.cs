...
namespace Servo.service
{
    ...
    {
        public static string process_get_post_comments_by_post_id(string post_id)
        {
            ...
            try
            {
                resp = model.get_post_comments_by_post_id.communicate_get_post_comments_by_post_id(post_id);
            }
            catch (Exception ex) { service.shared.log($"Error 1: {ex.Message} --service.get_post_comments_by_post_id.process_get_post_comments_by_post_id"); }
            ...
            */
            ...
            {
                shared.log($"Debug 1: {resp["status"]} --service.get_post_comments_by_post_id.process_get_post_comments_by_post_id");
                return "error";
            }
            else
            {
