...
namespace Servo.service
{
    ...
    {
        public static string process_get_all_featured_products()
        {
            ...
            try
            {
                resp = model.get_all_featured_products.communicate_get_all_featured_products();
            }
            catch (Exception ex) { service.shared.log($"Error 1: {ex.Message} --service.get_all_featured_products.process_get_all_featured_products"); }
            ...
            */
            ...
            {
                shared.log($"Debug 1: {resp["status"]} --service.get_all_featured_products.get_all_featured_productsW");
                return "error";
            }
            else
            {
