...
{
    internal class upload_post_image_admin
    {
        private static readonly HttpClient _http = new HttpClient();


        public static int process_upload_post_image(string controller_admin_id, string controller_sesstoken, string controller_post_id, string image_b64, out string saved_filename, string transparency)
        {
            saved_filename = "";
            ...
            try
            {
                ...
                string product_dir = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "public", "assets", "posts", controller_post_id);
                ...
                service.shared.log($"[upload] saved with bg removed: products/{controller_post_id}/{max + 1}.webp");
                return 200;
            }
            ...
            catch (Exception ex)
            {
                ...
                service.shared.log($"Error: {inner.Message} --service.upload_post_image_admin");
                return 500;
            }
        }
    }
