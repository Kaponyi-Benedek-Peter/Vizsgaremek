...
namespace Servo.service
{
    ...
    {
        public static string process_get_product_by_id(string id)
        {
            ...
            try
            {
                resp = model.get_product_by_id.communicate_get_product_by_id(id);
            }
            catch (Exception ex) { service.shared.log($"Error 1: {ex.Message} --service.get_product_by_id.process_get_product_by_id"); }
            ...
            */
            ...
            {
                shared.log($"Debug 1: {resp["status"]} --service.get_product_by_id.process_get_product_by_id");
                return "error";
            }
            else
            {
