...
namespace Servo.service
{
    ...
    {
        public static string process_get_all_posts(string category)
        {
            ...
            try
            {
                resp = model.get_all_posts.communicate_get_all_posts(category);
            }
            catch (Exception ex) { service.shared.log($"Error 1: {ex.Message} --service.get_all_posts.process_get_all_posts"); }
            ...
            */
            ...
            {
                shared.log($"Debug 1: {resp["status"]} --service.get_all_posts.process_get_all_posts");
                return "error";
            }
            else
            {
