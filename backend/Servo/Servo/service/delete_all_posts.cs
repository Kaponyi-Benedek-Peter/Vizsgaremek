...
namespace Servo.service
{
    internal class delete_all_posts
    {
        ...
        public static int process_delete_all_posts(string controller_admin_id, string controller_sesstoken)
        {
            ...
            if (model_sesstoken == controller_sesstoken && (admin_accstate == "admin" || admin_accstate == "superadmin"))
            {
                ...
                //do
                int result = model.delete_all_posts.communicate_delete_all_posts();
